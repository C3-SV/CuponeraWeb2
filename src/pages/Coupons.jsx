...
export const Coupons = () => {
  // Pendiente de agregar en el Store, ahorita esta con datos de prueba 
  const storeCoupons = useShopStore((state) => state.coupons);
  const coupons = storeCoupons?.length ? storeCoupons : mockCoupons;
